...
doorsViewBase::doorsViewBase() :
    buttonCallback(this, &doorsViewBase::buttonCallbackHandler)
{
    ...
    clock.setTypedText(touchgfx::TypedText(T___SINGLEUSE_BIIX));
    ...
    header.setTypedText(touchgfx::TypedText(T___SINGLEUSE_2803));
    head.add(header);
...
void doorsViewBase::setupScreen()
{

}

void doorsViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &toHome)
    {
        //toHome
